...
namespace Validator
{
    ...
    internal sealed class Validator : StatelessService
    {
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            ...
            {
                new ServiceInstanceListener(context => this.Create_wcf_communication(context),"ServiceEndpoint")
            };
        }
        ...
        private ICommunicationListener Create_wcf_communication(StatelessServiceContext context)
        {
            ...
            var end_point_config = context.CodePackageActivationContext.GetEndpoint("ServiceEndpoint");
            ...
            var listener = new WcfCommunicationListener<IValidation>(
                ...
                wcfServiceObject: new Validator_service(),
